      ...
      <section className="space-y-8">
        ...
        >
          <div className="col-span-6 space-y-4 text-justify animate-tilt-in-left delay-1000">
            <p>
              Mes racines jurassiennes sont mon point d’ancrage et la source de
              mon inspiration. Le Jura recèle une grande diversité de reliefs et
              de milieux naturels : lacs, étangs, forêts, rivières, montagnes,
              et une faune et une flore riches et variées. Chevreuils, renards,
              blaireaux, sangliers, écureuils, lapins, biches, chouettes...
              peuplent le Jura naturel et sauvage. Mais les animaux les plus
              emblématiques de cette région sont le lynx boréal, le grand
              tétras, le chamois, l’hermine et le faucon pèlerin.
            </p>

            <p>
              Le département est également une réserve naturelle pour les
              botanistes : gentianes, épicéas, sapins présidents, morilles,
              orchidées sauvages sont quelques-unes des espèces caractéristiques
              de la flore locale. J’ai grandi dans ce cadre exceptionnel que
              j’ai apprivoisé au fil du temps et qui me tient tellement à cœur.
            </p>
          </div>
          <Image
        ...
        >
          ...
          <div className="col-span-7 space-y-4 text-justify animate-tilt-in-right delay-1700">
            ...
            <p>
              ...
              autres métiers d’arts (nacrière, tourneurs sur cornes, tanneries,
              etc.).
            </p>
          </div>
        </div>
      ...
      <section className="space-y-8">
        ...
        >
          <p className="col-span-7 space-y-4 text-justify animate-tilt-in-left delay-2400">
            ...
            offre, le transformer, le mettre au goût du jour et lui donner vie,
      ...
      <section className="space-y-8">
        ...
        >
          <p className="col-span-7 space-y-4 text-justify animate-tilt-in-left delay-3800">
            ...
            peau à peau, ce contact sauvage et charnel, un retour vers la
            nature, un partage de sensations, un look atypique ou sophistiqué,
            se faire plaisir en étant vertueux.
          </p>
